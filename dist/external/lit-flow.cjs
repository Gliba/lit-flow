...
const system = require("@xyflow/system");
const lit = require("lit");
const staticHtml_js = require("lit/static-html.js");
...
exports.FlowCanvas = class FlowCanvas extends lit.LitElement {
  constructor() {
    super();
    this.nodes = [];
    this.edges = [];
...
exports.FlowCanvas.styles = lit.css`
    :host {
      display: block;
      width: 100%;
      height: 100%;
...
], exports.FlowCanvas.prototype, "nodes", 2);
__decorateClass$a([
  decorators_js.property({ type: Array })
], exports.FlowCanvas.prototype, "edges", 2);
__decorateClass$a([
...
exports.NodeResizer = class NodeResizer extends lit.LitElement {
  constructor() {
    super(...arguments);
    this.visible = false;
    this.minWidth = 10;
...
exports.NodeResizer.styles = lit.css`
    :host {
      position: absolute;
      top: 0;
      left: 0;
...
], exports.NodeResizer.prototype, "visible", 2);
__decorateClass$9([
  decorators_js.property({ type: Number })
], exports.NodeResizer.prototype, "minWidth", 2);
__decorateClass$9([
  decorators_js.property({ type: Number })
], exports.NodeResizer.prototype, "minHeight", 2);
__decorateClass$9([
  decorators_js.property({ type: Number })
], exports.NodeResizer.prototype, "maxWidth", 2);
__decorateClass$9([
  decorators_js.property({ type: Number })
], exports.NodeResizer.prototype, "maxHeight", 2);
__decorateClass$9([
  decorators_js.property({ type: Boolean })
], exports.NodeResizer.prototype, "keepAspectRatio", 2);
exports.NodeResizer = __decorateClass$9([
...
exports.FlowNode = class FlowNode extends lit.LitElement {
  constructor() {
    super(...arguments);
    this.id = "";
    this.data = {};
...
exports.FlowNode.styles = lit.css`
    :host {
      position: absolute;
...
], exports.FlowNode.prototype, "id", 2);
__decorateClass$8([
  decorators_js.property({ type: Object })
], exports.FlowNode.prototype, "data", 2);
__decorateClass$8([
  decorators_js.property({ type: Object })
], exports.FlowNode.prototype, "position", 2);
__decorateClass$8([
  decorators_js.property({ type: Boolean, reflect: true })
], exports.FlowNode.prototype, "selected", 2);
__decorateClass$8([
  decorators_js.property({ type: Boolean, reflect: true })
], exports.FlowNode.prototype, "dragging", 2);
__decorateClass$8([
  decorators_js.property({ type: Boolean })
], exports.FlowNode.prototype, "draggable", 2);
__decorateClass$8([
  decorators_js.property({ type: Object })
], exports.FlowNode.prototype, "instance", 2);
__decorateClass$8([
  decorators_js.property({ type: Boolean })
], exports.FlowNode.prototype, "resizable", 2);
exports.FlowNode = __decorateClass$8([
...
exports.FlowEdge = class FlowEdge extends lit.LitElement {
  constructor() {
    super(...arguments);
    this.id = "";
    this.source = "";
...
exports.FlowEdge.styles = lit.css`
    :host {
      position: absolute;
      top: 0;
      left: 0;
...
], exports.FlowEdge.prototype, "id", 2);
__decorateClass$7([
  decorators_js.property({ type: String })
], exports.FlowEdge.prototype, "source", 2);
__decorateClass$7([
  decorators_js.property({ type: String })
], exports.FlowEdge.prototype, "target", 2);
__decorateClass$7([
  decorators_js.property({ type: String })
], exports.FlowEdge.prototype, "sourceHandle", 2);
__decorateClass$7([
  decorators_js.property({ type: String })
], exports.FlowEdge.prototype, "targetHandle", 2);
__decorateClass$7([
  decorators_js.property({ type: Object })
], exports.FlowEdge.prototype, "sourceNode", 2);
__decorateClass$7([
  decorators_js.property({ type: Object })
], exports.FlowEdge.prototype, "targetNode", 2);
__decorateClass$7([
  decorators_js.property({ type: Boolean })
], exports.FlowEdge.prototype, "animated", 2);
__decorateClass$7([
  decorators_js.property({ type: Boolean })
...
__decorateClass$7([
  decorators_js.property({ type: String })
], exports.FlowEdge.prototype, "type", 2);
__decorateClass$7([
  decorators_js.property({ type: Object })
], exports.FlowEdge.prototype, "markerStart", 2);
__decorateClass$7([
  decorators_js.property({ type: Object })
...
exports.FlowBackground = class FlowBackground extends lit.LitElement {
  constructor() {
    super(...arguments);
    this.variant = "dots";
    this.gap = 20;
...
exports.FlowBackground.styles = lit.css`
    :host {
      position: absolute;
      inset: 0;
      pointer-events: none;
...
__decorateClass$6([
  decorators_js.property({ type: String })
], exports.FlowBackground.prototype, "variant", 2);
__decorateClass$6([
  decorators_js.property({ type: Number })
], exports.FlowBackground.prototype, "gap", 2);
__decorateClass$6([
  decorators_js.property({ type: String })
], exports.FlowBackground.prototype, "color", 2);
__decorateClass$6([
  decorators_js.property({ type: Number })
], exports.FlowBackground.prototype, "size", 2);
exports.FlowBackground = __decorateClass$6([
  decorators_js.customElement("flow-background")
], exports.FlowBackground);
...
exports.FlowMinimap = class FlowMinimap extends lit.LitElement {
  constructor() {
    super(...arguments);
    this.width = 200;
    this.height = 150;
...
exports.FlowMinimap.styles = lit.css`
    :host {
      position: absolute;
      bottom: 20px;
      right: 20px;
...
__decorateClass$5([
  decorators_js.property({ type: Number })
], exports.FlowMinimap.prototype, "width", 2);
__decorateClass$5([
  decorators_js.property({ type: Number })
], exports.FlowMinimap.prototype, "height", 2);
exports.FlowMinimap = __decorateClass$5([
...
exports.FlowControls = class FlowControls extends lit.LitElement {
  constructor() {
    super(...arguments);
    this.handleZoomIn = () => {
...
exports.FlowControls.styles = lit.css`
    :host {
      position: absolute;
      bottom: 20px;
      left: 20px;
...
__decorateClass$4([
  decorators_js.property({ type: Object })
], exports.FlowControls.prototype, "instance", 2);
exports.FlowControls = __decorateClass$4([
  decorators_js.customElement("flow-controls")
], exports.FlowControls);
...
exports.ERDTableNode = class ERDTableNode extends exports.FlowNode {
  constructor() {
    super(...arguments);
...
exports.ERDTableNode.styles = [
  ...Array.isArray(__superGet(exports.ERDTableNode, exports.ERDTableNode, "styles")) ? __superGet(exports.ERDTableNode, exports.ERDTableNode, "styles") : [__superGet(exports.ERDTableNode, exports.ERDTableNode, "styles")],
  lit.css`
      :host {
        padding: 0;
        min-width: 200px;
...
exports.ERDTableNode = __decorateClass$3([
  decorators_js.customElement("erd-table-node")
], exports.ERDTableNode);
const basicShapes = [
  {
    type: "circle",
    name: "Circle",
...
exports.ShapeNode = class ShapeNode extends lit.LitElement {
  constructor() {
    super(...arguments);
    this.id = "";
    this.selected = false;
...
exports.ShapeNode.styles = lit.css`
    :host {
      position: absolute;
      display: block;
      pointer-events: auto;
...
__decorateClass$2([
  decorators_js.property({ type: String, reflect: true })
], exports.ShapeNode.prototype, "id", 2);
__decorateClass$2([
  decorators_js.property({ type: Object })
], exports.ShapeNode.prototype, "data", 2);
__decorateClass$2([
...
], exports.ShapeNode.prototype, "position", 2);
__decorateClass$2([
  decorators_js.property({ type: Boolean, reflect: true })
], exports.ShapeNode.prototype, "selected", 2);
__decorateClass$2([
  decorators_js.property({ type: Boolean, reflect: true })
], exports.ShapeNode.prototype, "dragging", 2);
__decorateClass$2([
  decorators_js.property({ type: Boolean })
], exports.ShapeNode.prototype, "draggable", 2);
__decorateClass$2([
  decorators_js.property({ type: Boolean })
], exports.ShapeNode.prototype, "connectable", 2);
__decorateClass$2([
  decorators_js.property({ type: Object })
], exports.ShapeNode.prototype, "instance", 2);
__decorateClass$2([
  decorators_js.property({ type: Boolean })
], exports.ShapeNode.prototype, "resizable", 2);
exports.ShapeNode = __decorateClass$2([
...
exports.BaseNode = class BaseNode extends lit.LitElement {
  render() {
    return lit.html`<slot></slot>`;
  }
};
exports.BaseNode.styles = lit.css`
    :host {
      display: block;
  ...
  `;
exports.BaseNode = __decorateClass$1([
  decorators_js.customElement("base-node")
], exports.BaseNode);
exports.BaseNodeHeader = class BaseNodeHeader extends lit.LitElement {
  render() {
    return lit.html`<slot></slot>`;
  }
};
exports.BaseNodeHeader.styles = lit.css`
    :host {
      display: flex;
      align-items: center;
      gap: 8px;
  ...
  `;
exports.BaseNodeHeader = __decorateClass$1([
  decorators_js.customElement("base-node-header")
], exports.BaseNodeHeader);
exports.BaseNodeHeaderTitle = class BaseNodeHeaderTitle extends lit.LitElement {
  render() {
    return lit.html`<span class="title"><slot></slot></span>`;
  }
};
exports.BaseNodeHeaderTitle.styles = lit.css`
  ...
  `;
exports.BaseNodeHeaderTitle = __decorateClass$1([
  decorators_js.customElement("base-node-header-title")
], exports.BaseNodeHeaderTitle);
exports.BaseNodeContent = class BaseNodeContent extends lit.LitElement {
  render() {
    return lit.html`<slot></slot>`;
  }
};
exports.BaseNodeContent.styles = lit.css`
    :host {
      display: block;
      padding: 12px;
    }
  `;
exports.BaseNodeContent = __decorateClass$1([
  decorators_js.customElement("base-node-content")
], exports.BaseNodeContent);
exports.BaseNodeFooter = class BaseNodeFooter extends lit.LitElement {
  render() {
    return lit.html`<slot></slot>`;
  }
};
exports.BaseNodeFooter.styles = lit.css`
    :host {
      display: flex;
      align-items: center;
      gap: 8px;
  ...
  `;
exports.BaseNodeFooter = __decorateClass$1([
  decorators_js.customElement("base-node-footer")
], exports.BaseNodeFooter);
...
exports.LIT_FLOW_BUILD = LIT_FLOW_BUILD;
exports.LIT_FLOW_VERSION = LIT_FLOW_VERSION;
...
//# sourceMappingURL=lit-flow.cjs.map
