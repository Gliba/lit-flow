...
try {
    ...
    console.info(`%c lit-flow %c v${LIT_FLOW_VERSION} %c ${LIT_FLOW_BUILD} `, 'background:#1a73e8;color:#fff;border-radius:3px 0 0 3px;padding:2px 4px;font-weight:600', 'background:#111;color:#fff;padding:2px 4px', 'background:#e8f0fe;color:#1a73e8;border-radius:0 3px 3px 0;padding:2px 4px', '\nfeatures: measurement gate · batched notify · keyed repeat · robust fitView · fitViewOnInit · flow-render-complete · nested-aware notifyHandlesUpdated');
}
catch {
